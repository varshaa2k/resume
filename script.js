fetch('data.json?v=' + new Date().getTime())
    ...
    .then(data => {
        ...
        hero.querySelector('h1').textContent = `Welcome, I'm ${data.about.name}`;
        hero.querySelectorAll('p')[1].textContent = data.about.tagline;
        hero.querySelectorAll('p')[2].textContent = `${data.about.age} | ${data.about.profession} | ${data.about.roles.join(' | ')}`;
